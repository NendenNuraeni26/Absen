...
$result_paginated = $conn->query("SELECT * FROM karyawan LIMIT $start, $limit");
?>
            ...
            <div class="w-full bg-white rounded-2xl shadow p-10 mt-6 relative">
                ...
                <div class="flex items-center justify-center mb-6 relative">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 text-center">
                        Form Input Data Karyawan Rumah Sakit Muhammadiyah
                    </h1>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gray-50 shadow-xl rounded-xl p-5">
                        ...
                        <br>
                        <form action="aksikaryawan.php" method="POST" class="space-y-4">
                            <div class="mb-4">
                                <label for="nomor_karyawan" class="block text-base font-semibold text-gray-800 mb-2">
                                    Nomor Karyawan
                                </label>
                                <input
                                    type="text"
                            ...
                            <div class="mb-4">
                                <label for="nama_karyawan" class="block text-base font-semibold text-gray-800 mb-2">
                                    Nama Karyawan
                                </label>
                                <input
                                    type="text"
                            ...
                            <div class="mb-4">
                                <label for="id_unit" class="block text-base font-semibold text-gray-800 mb-2">
                                    Unit
                                </label>
                                <select
                                    name="id_unit"
                            ...
                            <p>
                                Nama Karyawan harus sesuai dengan nama asli yang terdaftar di rumah sakit.
                                Pastikan data yang dimasukkan benar sebelum menekan tombol <span class="font-semibold">Simpan</span>.
                            </p>
                        </form>
                    </div>
                    ...
                    <div class="flex justify-center items-center">
                        <img src="img/input.jpg" alt="Ilustrasi Karyawan" class="w-100">
                    </div>
