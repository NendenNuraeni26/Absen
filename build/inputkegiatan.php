...
// Ambil data kegiatan sesuai halaman
            ...
            <div class="w-full bg-white rounded-2xl shadow p-10 mt-6 relative">
                ...
                <div class="flex items-center justify-center mb-6 relative">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 text-center">
                        Form Input Kegiatan Rumah Sakit Muhammadiyah
                    </h1>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gray-50 shadow-xl rounded-xl p-5">
                        ...
                        <br>
                        <form action="aksikegiatan.php" method="POST" class="space-y-4">
                            ...
                            <!-- Tambahkan Jam Mulai -->
                            <div class="mb-4">
                                <label for="jam_mulai" class="block text-base font-semibold text-gray-800 mb-2">
                                    Jam Mulai
                                </label>
                                <input
                                    type="time"
                            ...
                            <div class="mb-4">
                                <label for="jam_selesai" class="block text-base font-semibold text-gray-800 mb-2">
                                    Jam Selesai
                                </label>
                                <input
                                    type="time"
                            ...
                            <p>
                                Masukkan kegiatan dengan benar untuk memastikan semua aktivitas tercatat dengan tepat dan dapat dilaporkan
